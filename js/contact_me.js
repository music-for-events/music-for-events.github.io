            ...
            $.ajax({
                ...
                error: function() {
                    ...
                    $('#success > .alert-danger').html("<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;")
                        .append("</button>");
                    $('#success > .alert-danger').append("<strong>Sorry " + firstName + " Der Mailserver antwortet nicht.</strong> Versuchen Sie es zu einem späteren Zeitpunkt wieder. Bitte entschuldigen Sie diese Unannehmlichkeit!");
